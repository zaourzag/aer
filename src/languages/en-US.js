...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_BRAIN_DESCRIPTON: 'Generates an expanding brain meme from a group of sentences.',
			COMMAND_BRAIN_EXTENDEDHELP: 'Separate the sentances using commas.', 
			...
			COMMAND_PUN_DESCRIPTION: 'Sends a random pun.',
			COMMAND_PUN_EXTENDEDHELP: 'Powered by http://icanhazdadjoke.com',
			...
			// social commands
			COMMAND_DAILY_DESCRIPTION: 'Claim your daily points!',
			COMMAND_DAILY_EXTENDEDHELP: 'Add a --reminder flag at the end of the command to be reminded of next dailies in 12 hours.',
